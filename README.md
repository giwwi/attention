...
[Website](https://giwwi.github.io/attention/) · [Chrome Web Store](https://chromewebstore.google.com/detail/attention/fcclhejgaklnkfgalglcmhmledgefhhp) · [Latest release](https://github.com/giwwi/attention/releases/tag/v0.29.0)
...
1. Download and unzip the [version 0.29.0](https://github.com/giwwi/attention/releases/download/v0.29.0/attention-0.29.0.zip).
...
For an existing unpacked installation, rebuild and click **Reload** in `chrome://extensions`, then refresh open article tabs. Version 0.29.0 includes the updated profile matching and decision policy from 0.28.1, plus prepared AI passage selection, consistent highlights and simpler onboarding. Earlier raw-score versions are excluded from the new calibration fit. A saved profile is still required for evaluation.
