...
**Your AI knows you. Now use that context on your terms.** Watch the profile transfer and reading demo: [English · 1:01](https://giwwi.github.io/attention/media/attention-your-context-en.mp4). The film uses an authored example profile and the real 0.30.2 interface; sequences are shortened.
